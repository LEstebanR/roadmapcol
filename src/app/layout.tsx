    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <Link
          ...
          target="_blank"
          className="fixed right-6 bottom-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg transition-all duration-300 hover:scale-110 hover:bg-green-600"
        >
